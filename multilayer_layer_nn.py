# -*- coding: utf-8 -*-
"""multilayer-layer-NN.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EbVbV8aEXyrqKje3TjN1Bv1JI1M7276d
"""
...
model = keras.Sequential([
    ...
    keras.layers.Dense(128, activation = "relu"), #additional layer of neural network.
    keras.layers.Dense(len(CLASS_NAMES), activation="softmax")
])

model.compile(
    optimizer="adam", # learning rate could be set here. by default it's 0.001 here
    loss="sparse_categorical_crossentropy",
    metrics=["accuracy"]
)

epoch = 5 # number of times you wanna go through the dataset for computations
...
"""This multilayer model can only help in reducing our loss, but not increasing our accuracy.
We can change the hyperparameters in our code/model, to get optimum results. followig HP can be changed:
1. Image size (224 x 224, 64 x 64, etc)
2. Batch Size (1, 8, 16, 64, etc)
3. Learning Rate (0.001 by default, could be changed accordingly)
4. epochs
"""
